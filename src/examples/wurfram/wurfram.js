...
(function (Wurfram) {
    ...
    var Player = /** @class */ (function (_super) {
        ...
        function Player(eventBus, assetRegistry, gameCanvas, keyboadControl) {
            ...
            Plestecin.Sprite.call(_this, _this.gameCanvas, config);
    ...
    var WurframGame = /** @class */ (function (_super) {
        __extends(WurframGame, _super);
        function WurframGame() {
            var _this = _super.call(this, "Wurfram") || this;
            _this.assetRegistry.loadImage('wurfram', 'images/wurfram.png');
            _this.assetRegistry.loadImage('rosa', 'images/rosa.png');
            _this.assetRegistry.loadImage('sausage', 'images/sausage2.png');
            _this.assetRegistry.loadImage('burger', 'images/burger-tom.png');
            _this.assetRegistry.loadImage('pizza', 'images/pizza-tom.png');
            _this.engine.addState(Engine.initState(WurframGame.INTRO_STATE));
            _this.engine.addState(Engine.initState(WurframGame.GAME_OVER_STATE));
            _this.engine.addState(Engine.initState(WurframGame.PAUSE_STATE));
