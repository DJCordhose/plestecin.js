...
var Plestecin;
(function (Plestecin) {
    var PoseControl = /** @class */ (function () {
        function PoseControl() {
            this.pressed = {};
        }
        PoseControl.prototype.init = function (eventBus, success) {
            var _this = this;
        ...
        PoseControl.prototype.cursorControl = function () {
            var currentControl = {};
    ...
    Plestecin.PoseControl = PoseControl;
})(Plestecin || (Plestecin = {}));
//# sourceMappingURL=poseControl.js.map