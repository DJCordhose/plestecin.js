...
var Plestecin;
(function (Plestecin) {
    var Game /* implements GameObject */ = /** @class */ (function () {
        function Game(gameName, canvasId) {
            this.gameName = gameName;
            this.currentScore = 0;
            this.engine = new Plestecin.Engine();
            this.gameCanvas = Plestecin.GameCanvas ? (canvasId ? new Plestecin.GameCanvas({ canvasId: canvasId, width: 1000, height: 800 }) : new Plestecin.GameCanvas()) : null;
